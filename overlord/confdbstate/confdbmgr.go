...
func Manager(st *state.State, hookMgr *hookstate.HookManager, runner *state.TaskRunner, mgmtMgr *devicemgmtstate.DeviceMgmtManager) *ConfdbManager {
	...
	mgmtMgr.RegisterHandler("confdb", &confdbMessageHandler{})
